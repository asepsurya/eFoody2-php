  ...
  <div class="osahan-popular">
    ...
    <div class="container">
      <div class="search py-5">
        ...
        $query = "SELECT * FROM tbl_produk where jenis_produk='$id_kategori' ";
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            if (isset($_GET['kata_kunci'])) {
              ...
              $query = "select * from tbl_produk where jenis_produk like '%".$kata_kunci."%' order by id_produk asc";
          ...
          <div class="col-md-3 pb-3">
            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
              ...
              <div class="list-card-badge">
                Rp. <?= number_format($data['harga_produk'],0,".",".")  ?> <span class="badge badge-danger">IDR</span> 
              </div><br>
              <?php 
